...
const Map<String, dynamic> appLocaleRu = {
  ...
  AppLocale.steamGridDbDescription:
      'Дополнительный источник обложек, фонов и логотипов, независимый от ScreenScraper. Заполняет только отсутствующие изображения, не перезаписывает существующие.',
  AppLocale.steamGridDbGetKey: 'Получить бесплатный API-ключ ↗',
  AppLocale.steamGridDbApiKeyHint: 'Вставьте свой API-ключ SteamGridDB',
  AppLocale.steamGridDbSaveKey: 'Сохранить ключ',
  AppLocale.steamGridDbClearKey: 'Удалить ключ',
  AppLocale.steamGridDbStartScraping: 'Начать скрапинг',
  AppLocale.steamGridDbInvalidKey: 'Недействительный API-ключ',
  AppLocale.steamGridDbKeySaved: 'API-ключ сохранён',
