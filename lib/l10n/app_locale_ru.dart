...
const Map<String, dynamic> appLocaleRu = {
  ...
  AppLocale.raCoverageMatched: 'Есть достижения',
  AppLocale.raCoverageNoSet: 'Нет набора на RetroAchievements',
  AppLocale.raCoverageNotChecked: 'Ещё не проверено',
  AppLocale.raCoverageDiscPending: 'Диск, пока не поддерживается',
