...
const Map<String, dynamic> appLocaleRu = {
  ...
  AppLocale.systemTypeArcade: 'аркадная система',
  AppLocale.systemTypeVirtual: 'виртуальная система',
  ...
  AppLocale.systemGeneration: 'Поколение',
  AppLocale.systemProcessor: 'Процессор',
  AppLocale.systemMedia: 'Носитель',
  ...
  AppLocale.mediaFloppy: 'Дискета',
  AppLocale.mediaCassette: 'Кассета',
  AppLocale.mediaDigital: 'Цифровая загрузка',
  AppLocale.mediaArcadeBoard: 'Аркадная плата',
  AppLocale.mediaOpticalDisc: 'Оптический диск',
  AppLocale.mediaUmd: 'UMD',
  AppLocale.mediaGdRom: 'GD-ROM',
  AppLocale.mediaHuCard: 'HuCard',
  AppLocale.mediaBuiltIn: 'Встроенное ПО',
  AppLocale.mediaBroadcast: 'Трансляция / загрузка',
  AppLocale.mediaHardDisk: 'Жёсткий диск',
  AppLocale.mediaCard: 'Карта',
  AppLocale.mediaVarious: 'Разные носители',
};
