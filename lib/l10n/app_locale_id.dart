...
const Map<String, dynamic> appLocaleId = {
  ...
  AppLocale.steamGridDbDescription:
      'Sumber artwork tambahan untuk cover, latar belakang, dan logo, independen dari ScreenScraper. Hanya mengisi gambar yang hilang, tidak menimpa yang sudah ada.',
  AppLocale.steamGridDbGetKey: 'Dapatkan kunci API gratis ↗',
  AppLocale.steamGridDbApiKeyHint: 'Tempel kunci API SteamGridDB Anda',
  AppLocale.steamGridDbSaveKey: 'Simpan Kunci',
  AppLocale.steamGridDbClearKey: 'Hapus Kunci',
  AppLocale.steamGridDbStartScraping: 'Mulai Scraping',
  AppLocale.steamGridDbInvalidKey: 'Kunci API tidak valid',
  AppLocale.steamGridDbKeySaved: 'Kunci API tersimpan',
