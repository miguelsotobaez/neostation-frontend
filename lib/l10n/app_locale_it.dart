...
const Map<String, dynamic> appLocaleIt = {
  ...
  AppLocale.steamGridDbDescription:
      'Fonte di artwork aggiuntiva per copertine, sfondi e loghi, indipendente da ScreenScraper. Completa solo le immagini mancanti, non sovrascrive quelle esistenti.',
  AppLocale.steamGridDbGetKey: 'Ottieni una chiave API gratuita ↗',
  AppLocale.steamGridDbApiKeyHint: 'Incolla la tua chiave API SteamGridDB',
  AppLocale.steamGridDbSaveKey: 'Salva chiave',
  AppLocale.steamGridDbClearKey: 'Rimuovi chiave',
  AppLocale.steamGridDbStartScraping: 'Avvia scraping',
  AppLocale.steamGridDbInvalidKey: 'Chiave API non valida',
  AppLocale.steamGridDbKeySaved: 'Chiave API salvata',
