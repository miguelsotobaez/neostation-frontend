...
const Map<String, dynamic> appLocaleFr = {
  ...
  AppLocale.systemTypeArcade: 'système d’arcade',
  AppLocale.systemTypeVirtual: 'système virtuel',
  ...
  AppLocale.systemGeneration: 'Génération',
  AppLocale.systemProcessor: 'Processeur',
  AppLocale.systemMedia: 'Support',
  ...
  AppLocale.mediaFloppy: 'Disquette',
  AppLocale.mediaCassette: 'Cassette',
  AppLocale.mediaDigital: 'Téléchargement numérique',
  AppLocale.mediaArcadeBoard: 'Carte d’arcade',
  AppLocale.mediaOpticalDisc: 'Disque optique',
  AppLocale.mediaUmd: 'UMD',
  AppLocale.mediaGdRom: 'GD-ROM',
  AppLocale.mediaHuCard: 'HuCard',
  AppLocale.mediaBuiltIn: 'Logiciel intégré',
  AppLocale.mediaBroadcast: 'Diffusion / téléchargement',
  AppLocale.mediaHardDisk: 'Disque dur',
  AppLocale.mediaCard: 'Carte',
  AppLocale.mediaVarious: 'Supports variés',
};
