...
const Map<String, dynamic> appLocaleFr = {
  ...
  AppLocale.raCoverageMatched: 'A des succès',
  AppLocale.raCoverageNoSet: 'Aucun set sur RetroAchievements',
  AppLocale.raCoverageNotChecked: 'Pas encore vérifié',
  AppLocale.raCoverageDiscPending: 'Disque, pas encore pris en charge',
