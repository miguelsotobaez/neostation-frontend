...
const Map<String, dynamic> appLocaleEs = {
  ...
  AppLocale.steamGridDbDescription:
      'Fuente adicional de artwork para carátulas, fondos y logos, independiente de ScreenScraper. Solo completa imágenes faltantes, nunca sobrescribe las existentes.',
  AppLocale.steamGridDbGetKey: 'Obtener clave API gratuita ↗',
  AppLocale.steamGridDbApiKeyHint: 'Pega tu clave API de SteamGridDB',
  AppLocale.steamGridDbSaveKey: 'Guardar clave',
  AppLocale.steamGridDbClearKey: 'Eliminar clave',
  AppLocale.steamGridDbStartScraping: 'Iniciar scraping',
  AppLocale.steamGridDbInvalidKey: 'Clave API no válida',
  AppLocale.steamGridDbKeySaved: 'Clave API guardada',
