...
const Map<String, dynamic> appLocaleEs = {
  ...
  AppLocale.iosEmuResync: "Volver a sincronizar",
  ...
  AppLocale.systemGeneration: 'Generación',
  AppLocale.systemProcessor: 'Procesador',
  AppLocale.systemMedia: 'Soporte',
  ...
  AppLocale.mediaCassette: 'Casete',
  AppLocale.mediaDigital: 'Descarga digital',
  AppLocale.mediaArcadeBoard: 'Placa arcade',
  ...
  AppLocale.mediaBroadcast: 'Emisión / descarga',
  AppLocale.mediaHardDisk: 'Disco duro',
  AppLocale.mediaCard: 'Tarjeta',
  AppLocale.mediaVarious: 'Varios soportes',
};
