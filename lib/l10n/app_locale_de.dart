...
const Map<String, dynamic> appLocaleDe = {
  ...
  AppLocale.steamGridDbDescription:
      'Zusätzliche Artwork-Quelle für Cover, Hintergründe und Logos, unabhängig von ScreenScraper. Füllt nur fehlende Bilder auf, überschreibt nichts Vorhandenes.',
  AppLocale.steamGridDbGetKey: 'Kostenlosen API-Schlüssel holen ↗',
  AppLocale.steamGridDbApiKeyHint: 'SteamGridDB API-Schlüssel einfügen',
  AppLocale.steamGridDbSaveKey: 'Schlüssel speichern',
  AppLocale.steamGridDbClearKey: 'Schlüssel entfernen',
  AppLocale.steamGridDbStartScraping: 'Scraping starten',
  AppLocale.steamGridDbInvalidKey: 'API-Schlüssel ungültig',
  AppLocale.steamGridDbKeySaved: 'API-Schlüssel gespeichert',
