...
const Map<String, dynamic> appLocaleDe = {
  ...
  AppLocale.systemTypeArcade: 'Arcade-System',
  AppLocale.systemTypeVirtual: 'virtuelles System',
  ...
  AppLocale.systemGeneration: 'Generation',
  AppLocale.systemProcessor: 'Prozessor',
  AppLocale.systemMedia: 'Medium',
  ...
  AppLocale.mediaFloppy: 'Diskette',
  AppLocale.mediaCassette: 'Kassette',
  AppLocale.mediaDigital: 'Digitaler Download',
  AppLocale.mediaArcadeBoard: 'Arcade-Platine',
  AppLocale.mediaOpticalDisc: 'Optischer Datenträger',
  AppLocale.mediaUmd: 'UMD',
  AppLocale.mediaGdRom: 'GD-ROM',
  AppLocale.mediaHuCard: 'HuCard',
  AppLocale.mediaBuiltIn: 'Integrierte Software',
  AppLocale.mediaBroadcast: 'Übertragung / Download',
  AppLocale.mediaHardDisk: 'Festplatte',
  AppLocale.mediaCard: 'Karte',
  AppLocale.mediaVarious: 'Verschiedene Medien',
};
