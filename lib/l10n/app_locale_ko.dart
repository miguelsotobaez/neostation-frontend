...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.steamGridDbDescription:
      '커버, 배경, 로고를 위한 추가 아트워크 소스로, ScreenScraper와 독립적으로 작동합니다. 누락된 이미지만 채우며 기존 이미지는 덮어쓰지 않습니다.',
  AppLocale.steamGridDbGetKey: '무료 API 키 받기 ↗',
  AppLocale.steamGridDbApiKeyHint: 'SteamGridDB API 키를 붙여넣으세요',
  AppLocale.steamGridDbSaveKey: '키 저장',
  AppLocale.steamGridDbClearKey: '키 삭제',
  AppLocale.steamGridDbStartScraping: '스크래핑 시작',
  AppLocale.steamGridDbInvalidKey: 'API 키가 유효하지 않습니다',
  AppLocale.steamGridDbKeySaved: 'API 키가 저장되었습니다',
