...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.manage: '관리',
  AppLocale.manual: '게임 설명서',
  AppLocale.scrapeManualDesc: '사용 가능한 경우 PDF 게임 설명서를 다운로드합니다.',
  AppLocale.manualReady: '설명서 다운로드 완료',
  AppLocale.manualNotDownloaded: '다운로드한 설명서 없음',
  AppLocale.manualDownloadHint: 'ScreenScraper에 있는 경우 게임 설명서를 다운로드합니다.',
  AppLocale.downloadManual: '설명서 다운로드',
  AppLocale.downloadManualDesc: '언어와 지역에 가장 적합한 PDF를 다운로드합니다.',
  AppLocale.readManual: '설명서 읽기',
  AppLocale.readManualDesc: '저장된 PDF를 NeoStation 내장 리더에서 엽니다.',
  AppLocale.redownloadManual: '설명서 다시 다운로드',
  AppLocale.redownloadManualDesc: '로컬 사본을 사용 가능한 최적 버전으로 교체합니다.',
  AppLocale.deleteManual: '설명서 삭제',
  AppLocale.deleteManualDesc: '이 기기에서 저장된 PDF를 삭제합니다.',
  AppLocale.deleteManualConfirmation: '이 게임의 다운로드된 설명서를 삭제할까요?',
  AppLocale.manualDownloaded: '설명서 다운로드 완료',
  AppLocale.manualDownloadFailed: '설명서 다운로드 실패',
  AppLocale.manualNotAvailable: 'ScreenScraper에 이 게임의 설명서가 없습니다.',
  AppLocale.manualDeleted: '설명서 삭제 완료',
  AppLocale.downloadingManual: '설명서 다운로드 중...',
  AppLocale.pinchToZoom: '두 손가락으로 확대',
  ...
  AppLocale.systemTypeArcade: '아케이드 시스템',
  AppLocale.systemTypeVirtual: '가상 시스템',
  ...
  AppLocale.iosEmuSync: "동기화",
  AppLocale.iosEmuResync: "다시 동기화",
  ...
  AppLocale.systemGeneration: '세대',
  AppLocale.systemProcessor: '프로세서',
  AppLocale.systemMedia: '매체',
  ...
  AppLocale.mediaBluRay: 'Blu-ray',
  AppLocale.mediaFloppy: '플로피 디스크',
  AppLocale.mediaCassette: '카세트',
  AppLocale.mediaDigital: '디지털 다운로드',
  AppLocale.mediaArcadeBoard: '아케이드 보드',
  AppLocale.mediaOpticalDisc: '광디스크',
  AppLocale.mediaUmd: 'UMD',
  AppLocale.mediaGdRom: 'GD-ROM',
  AppLocale.mediaHuCard: 'HuCard',
  AppLocale.mediaBuiltIn: '내장 소프트웨어',
  AppLocale.mediaBroadcast: '방송 / 다운로드',
  AppLocale.mediaHardDisk: '하드 디스크',
  AppLocale.mediaCard: '카드',
  AppLocale.mediaVarious: '다양한 매체',
};
