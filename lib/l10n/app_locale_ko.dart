...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.rematchAchievementsWarning:
      '일치하지 않는 모든 ROM을 읽어 식별합니다. 라이브러리가 크면 시간이 걸릴 수 있습니다. 다시 선택하면 일시정지됩니다. 지금까지 일치한 항목은 모두 유지되며, 다시 실행하면 중단된 지점부터 이어집니다. 디스크 기반 시스템은 현재 건너뜁니다. 파일을 옮기거나 삭제하지 않습니다.',
  ...
  AppLocale.raCoverageMatched: '업적 있음',
  AppLocale.raCoverageNoSet: 'RetroAchievements에 세트 없음',
  AppLocale.raCoverageNotChecked: '아직 확인 안 됨',
  AppLocale.raCoverageDiscPending: '디스크, 아직 미지원',
