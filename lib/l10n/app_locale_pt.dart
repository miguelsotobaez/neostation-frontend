...
const Map<String, dynamic> appLocalePt = {
  ...
  AppLocale.steamGridDbDescription:
      'Fonte adicional de artwork para capas, fundos e logos, independente do ScreenScraper. Preenche apenas imagens ausentes, nunca substitui as existentes.',
  AppLocale.steamGridDbGetKey: 'Obter chave de API gratuita ↗',
  AppLocale.steamGridDbApiKeyHint: 'Cole sua chave de API do SteamGridDB',
  AppLocale.steamGridDbSaveKey: 'Salvar chave',
  AppLocale.steamGridDbClearKey: 'Remover chave',
  AppLocale.steamGridDbStartScraping: 'Iniciar scraping',
  AppLocale.steamGridDbInvalidKey: 'Chave de API inválida',
  AppLocale.steamGridDbKeySaved: 'Chave de API salva',
