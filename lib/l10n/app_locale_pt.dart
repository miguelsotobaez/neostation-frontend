...
const Map<String, dynamic> appLocalePt = {
  ...
  AppLocale.collectionImages: 'Imagens da coleção',
  ...
  AppLocale.selection: 'Seleção',
  AppLocale.selectedGames: 'Selecionados',
  AppLocale.unselectedGames: 'Não selecionados',
