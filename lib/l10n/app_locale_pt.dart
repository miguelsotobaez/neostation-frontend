...
const Map<String, dynamic> appLocalePt = {
  ...
  AppLocale.raCoverageMatched: 'Tem conquistas',
  AppLocale.raCoverageNoSet: 'Sem conjunto no RetroAchievements',
  AppLocale.raCoverageNotChecked: 'Ainda não verificado',
  AppLocale.raCoverageDiscPending: 'Disco, ainda não suportado',
