...
const Map<String, dynamic> appLocaleEn = {
  ...
  AppLocale.steamGridDbDescription:
      'Additional artwork source for covers, backgrounds and logos, independent of ScreenScraper. Fills in missing images only, never overwrites existing ones.',
  AppLocale.steamGridDbGetKey: 'Get a free API key ↗',
  AppLocale.steamGridDbApiKeyHint: 'Paste your SteamGridDB API key',
  AppLocale.steamGridDbSaveKey: 'Save Key',
  AppLocale.steamGridDbClearKey: 'Remove Key',
  AppLocale.steamGridDbStartScraping: 'Start Scraping',
  AppLocale.steamGridDbInvalidKey: 'Invalid API key',
  AppLocale.steamGridDbKeySaved: 'API key saved',
