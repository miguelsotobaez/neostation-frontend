...
const Map<String, dynamic> appLocaleEn = {
  ...
  AppLocale.raCoverageMatched: 'Has achievements',
  AppLocale.raCoverageNoSet: 'No set on RetroAchievements',
  AppLocale.raCoverageNotChecked: 'Not checked yet',
  AppLocale.raCoverageDiscPending: 'Disc, not supported yet',
