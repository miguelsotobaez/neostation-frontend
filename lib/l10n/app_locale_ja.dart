...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.steamGridDbDescription:
      'カバー、背景、ロゴ用の追加アートワークソース。ScreenScraperとは独立して動作し、不足している画像のみを補完し、既存のものは上書きしません。',
  AppLocale.steamGridDbGetKey: '無料のAPIキーを取得 ↗',
  AppLocale.steamGridDbApiKeyHint: 'SteamGridDB APIキーを貼り付け',
  AppLocale.steamGridDbSaveKey: 'キーを保存',
  AppLocale.steamGridDbClearKey: 'キーを削除',
  AppLocale.steamGridDbStartScraping: 'スクレイピング開始',
  AppLocale.steamGridDbInvalidKey: 'APIキーが無効です',
  AppLocale.steamGridDbKeySaved: 'APIキーを保存しました',
