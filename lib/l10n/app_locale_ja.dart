...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.openOnSecondScreen: 'セカンドスクリーンで開く',
  AppLocale.openOnSecondScreenSubtitle: 'このシステムのゲームをセカンドディスプレイで起動します',
  AppLocale.openOnSecondScreenEnabled: 'ゲームはセカンドスクリーンで開きます',
  AppLocale.openOnSecondScreenDisabled: 'ゲームはメインスクリーンで開きます',
