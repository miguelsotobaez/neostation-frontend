...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.manage: '管理',
  AppLocale.manual: '取扱説明書',
  AppLocale.scrapeManualDesc: '利用可能な場合、ゲームのPDF取扱説明書をダウンロードします。',
  AppLocale.manualReady: '取扱説明書をダウンロード済み',
  AppLocale.manualNotDownloaded: '取扱説明書は未ダウンロードです',
  AppLocale.manualDownloadHint: 'ScreenScraperにある場合、ゲームの取扱説明書をダウンロードできます。',
  AppLocale.downloadManual: '取扱説明書をダウンロード',
  AppLocale.downloadManualDesc: '言語と地域に合う最適なPDFをダウンロードします。',
  AppLocale.readManual: '取扱説明書を読む',
  AppLocale.readManualDesc: '保存済みPDFをNeoStation内蔵リーダーで開きます。',
  AppLocale.redownloadManual: '取扱説明書を再ダウンロード',
  AppLocale.redownloadManualDesc: 'ローカルコピーを利用可能な最適版に置き換えます。',
  AppLocale.deleteManual: '取扱説明書を削除',
  AppLocale.deleteManualDesc: '保存済みPDFをこの端末から削除します。',
  AppLocale.deleteManualConfirmation: 'このゲームのダウンロード済み取扱説明書を削除しますか？',
  AppLocale.manualDownloaded: '取扱説明書をダウンロードしました',
  AppLocale.manualDownloadFailed: '取扱説明書のダウンロードに失敗しました',
  AppLocale.manualNotAvailable: 'ScreenScraperにこのゲームの取扱説明書はありません。',
  AppLocale.manualDeleted: '取扱説明書を削除しました',
  AppLocale.downloadingManual: '取扱説明書をダウンロード中...',
  AppLocale.pinchToZoom: 'ピンチでズーム',
  ...
  AppLocale.systemTypeArcade: 'アーケードシステム',
  AppLocale.systemTypeVirtual: '仮想システム',
  ...
  AppLocale.systemProcessor: 'プロセッサ',
  AppLocale.systemMedia: 'メディア',
  ...
  AppLocale.mediaFloppy: 'フロッピーディスク',
  AppLocale.mediaCassette: 'カセットテープ',
  AppLocale.mediaDigital: 'デジタル配信',
  AppLocale.mediaArcadeBoard: 'アーケード基板',
  AppLocale.mediaOpticalDisc: '光ディスク',
  AppLocale.mediaUmd: 'UMD',
  AppLocale.mediaGdRom: 'GD-ROM',
  AppLocale.mediaHuCard: 'HuCard',
  AppLocale.mediaBuiltIn: '内蔵ソフトウェア',
  AppLocale.mediaBroadcast: '放送 / ダウンロード',
  AppLocale.mediaHardDisk: 'ハードディスク',
  AppLocale.mediaCard: 'カード',
  AppLocale.mediaVarious: '各種メディア',
};
