...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.showCollectionsTab: 'コレクションタブを表示',
  AppLocale.showCollectionsTabSubtitle: 'ナビゲーションバーにコレクションタブを表示します',
  ...
  AppLocale.deleteCollectionConfirm:
      'このコレクションを削除してもよろしいですか？ゲームはライブラリから削除されません。',
  AppLocale.collectionName: 'コレクション名',
  AppLocale.collectionNameHint: 'コレクション名を入力...',
  AppLocale.collectionDescription: '説明',
  AppLocale.noCollectionsTitle: 'コレクションがありません',
  AppLocale.noCollectionsSubtitle: 'コレクションを作成してお気に入りのゲームをシステム横断で整理しましょう。',
  AppLocale.emptyCollectionTitle: 'コレクションにゲームがありません',
  AppLocale.emptyCollectionSubtitle: 'ライブラリからこのコレクションにゲームを追加してください。',
  AppLocale.addGames: 'ゲームを追加',
  AppLocale.manageGames: 'ゲームを管理',
  AppLocale.removeFromCollection: 'コレクションから削除',
  AppLocale.removeFromCollectionConfirm: 'このゲームをコレクションから削除しますか？',
  AppLocale.gamesCountSingle: '{count} 本のゲーム',
  AppLocale.gamesCountPlural: '{count} 本のゲーム',
  AppLocale.collectionCreated: 'コレクションを作成しました',
  AppLocale.collectionUpdated: 'コレクションを更新しました',
  ...
  AppLocale.raCoverageNoSet: 'セットなし',
  AppLocale.raCoverageNotChecked: '未確認',
  AppLocale.raCoverageDiscPending: 'ディスク、未対応',
