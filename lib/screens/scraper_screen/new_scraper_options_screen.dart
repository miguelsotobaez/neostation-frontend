...
import 'scraper_contents/howlongtobeat_content.dart';
...
class _NewScraperOptionsScreenState extends State<NewScraperOptionsScreen> {
  ...
  final GlobalKey<HowLongToBeatContentState> _hltbKey =
      GlobalKey<HowLongToBeatContentState>();
  ...
  void _initializeMenuItems() {
    ...
    _menuItems.add(
      ScraperMenuItem(
        title: AppLocale.howLongToBeat.getString(context),
        localeKey: AppLocale.howLongToBeat,
  ...
  int _getContentItemCount() {
    ...
    if (selectedKey == AppLocale.howLongToBeat) {
      return HowLongToBeatContent.itemCount;
    }
    return 0;
  }
  ...
  void _selectContentItem() {
    ...
    } else if (selectedKey == AppLocale.howLongToBeat) {
      _hltbKey.currentState?.selectItem(_selectedContentIndex);
    }
  }
